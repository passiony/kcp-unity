...
namespace Network
{
	public sealed class SessionServer
	{
		...
		private void Run(MemoryStream memoryStream)
		{
			...
			// Server.MessageDispatcher.Dispatch(this, memoryStream.GetBuffer());
			Server.ReceiveBytesHandle?.Invoke(memoryStream.GetBuffer());
		}
